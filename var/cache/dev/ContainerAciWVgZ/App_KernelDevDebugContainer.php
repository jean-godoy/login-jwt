...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getDebug_Security_FirewallService()
    {
        return $this->privates['debug.security.firewall'] = new \Symfony\Bundle\SecurityBundle\Debug\TraceableFirewallListener(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'security.firewall.map.context.check' => ['privates', 'security.firewall.map.context.check', 'getSecurity_Firewall_Map_Context_CheckService', true],
            ...
            'security.firewall.map.context.check' => '?',
            ...
            yield 'security.firewall.map.context.check' => ($this->privates['.security.request_matcher.TGtM6RT'] ?? ($this->privates['.security.request_matcher.TGtM6RT'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/check')));
